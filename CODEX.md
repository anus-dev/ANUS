...
Codex reads `AGENTS.md` on its own. This file adds what is specific to Codex; it cannot weaken `AGENTS.md`, and where the two disagree, `AGENTS.md` wins. Read it after `AGENTS.md` and `ANUS.md`, before touching the repository or any tool.

How to answer the human is in `AGENTS.md`, section "Answers the human can use"; it applies to Codex as to every agent.
